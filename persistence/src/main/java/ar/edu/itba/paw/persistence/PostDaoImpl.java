...
public class PostDaoImpl implements PostDao {
    ...
    public Post register(String title, String body, int wordCount, PostCategory category, User user, Set<String> tags, Set<Movie> movies, boolean enabled) {
        ...
        final Post post = new Post(LocalDateTime.now(), title, body, wordCount, category, user, tags, false, null, enabled, Collections.emptySet(), Collections.emptySet(),movies, Collections.emptySet());
