...
define([], function() {
  ...
  return {
    ...
    INDEX_SLOGAN: 'Se acabó la peli?',
    INDEX_MY_FEED: 'Mi Feed',
    ...
    MOOVIFY: 'Moovify',
    USER_LOGIN_TITLE: 'Moovify | Ingresar',
    ...
    USER_LOGIN_RESETPASSWORD: 'Olvide mi contraseña',
    ...
    USER_CREATE_SELECTFILE: 'Seleciona un archivo',
    ...
    USER_EMAILCONFIRM_TITLE: 'Se requiere confirmar de email',
    USER_EMAILCONFIRM_TEXT: 'Para poder crear un post, debes confirmar tu dirección email. Chequea tu casilla de email, te enviamos un link!',
    USER_EMAILCONFIRM_PROFILE: "Por favor inserta aquí el token que recibiste en tu email al registrarte. Si no lo tienes ",
    USER_PROFILE_RESENDEMAIL: 'Reenviar email',
    USER_TOKEN_CONFIRM: "Confirmar",
    USER_TOKEN_ERROR: "Token inválido",
    USER_EMAILCONFIRM_CLOSEMODAL: 'Ok, lo tienes!',
    ...
    MOVIES_DISCUSSED: 'Películas discutidas:',
    ...
    UPDATE_PASS_BTN: 'Cambiar password',
