define(['angular', 'angularMocks', 'frontend', 'services/fetch/MovieFetchService', 'restangular', 'polyfillURLSearchParams'], function(angular) {

  describe('MovieFetchService', function() {
    ...
    it('search movies success test', inject(function (MovieFetchService) {
