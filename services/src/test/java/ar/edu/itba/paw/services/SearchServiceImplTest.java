...
public class SearchServiceImplTest {
    ...
    @Test
    public void getAllPostSortCriteria() {

        searchService.getAllPostSortCriteria();
    }

    @Test
    public void getAllMoviesSortCriteria() {

        searchService.getAllMoviesSortCriteria();
    }

    @Test
    public void getAllUserSortCriteria() {

        searchService.getAllUserSortCriteria();
    }

    @Test
    public void getPostPeriodOptions() {

        searchService.getPostPeriodOptions();
    }

    @Test
    public void getPostCategories() {

        searchService.getPostCategories();
    }

    @Test
    public void getMoviesCategories() {

        searchService.getMoviesCategories();
    }

    @Test
    public void getMoviesDecades() {

        searchService.getMoviesDecades();
    }

    @Test
    public void getUserRoleOptions() {

        searchService.getUserRoleOptions();
    }
}