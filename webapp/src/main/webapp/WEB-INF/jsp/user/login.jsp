...
<div class="uk-container uk-container-xsmall uk-margin-medium-top">
    <form method="post">
        <fieldset class="uk-fieldset">
            ...
            <div class="uk-text-center uk-text-bold uk-text-muted uk-margin"><spring:message code="user.login.noAccount"/> <a href="<c:url value="/user/create"/>"><spring:message code="user.create.signUp"/></a></div>
        </fieldset>
    </form>
