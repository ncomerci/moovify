            ...
            <div class="uk-flex">
                <div class="uk-width-expand uk-margin-small-top uk-margin-small-bottom uk-text-truncate">
                    <p class="uk-text-capitalize uk-text-meta uk-margin-remove-vertical">
                        ...
                        <spring:message code="postDisplay.meta.votes" arguments="${post.totalVotes}"/>
                        <span uk-icon="icon: <c:out value="${post.totalVotes >= 0 ? 'chevron-up':'chevron-down'}"/>; ratio: 0.8"></span>
                    </p>
