...
<div>
    ...
    <div class="uk-margin-left uk-margin-bottom" >
        <form:label path="title" class="uk-form-label uk-text-secondary uk-margin-auto" for="title-text" ><spring:message code="post.create.newPostTitle"/>
            <form:input path="title" class="uk-input uk-form-small" id="title-text" type="text" minlength="6" placeholder="${titlePlaceholder}" required="required" />
        </form:label>
    ...
    <div id="movies-modal" class="uk-modal-container" uk-modal>
        <div class="uk-modal-dialog uk-modal-body uk-border-rounded">
            ...
            <div>
                <h1 class="uk-h1 uk-margin-remove-top"><spring:message code="post.create.modal.moviesDiscussed.title"/></h1>
                <label for="add-movie-input" ><spring:message code="post.create.modal.moviesDiscussed.constrains"/></label>
                <div class="uk-flex">
                    <input id="add-movie-input"  class="uk-input uk-margin-right uk-input uk-border-rounded uk-width-expand" list="movie-list" placeholder="<spring:message code="post.create.modal.moviesPlaceholder"/>">
                    <button id="add-movie-button" class="uk-button uk-button-primary uk-border-rounded uk-width-auto" type="button"><spring:message code="post.create.modal.addButton"/></button>
                </div>
                <p id="movie-error" class="uk-margin-remove-top" style="display: none; color: red" ><spring:message code="post.create.modal.movieError.client"/></p>
            </div>
            ...
            <div class="uk-margin-medium">
                ...
                <label for="add-tag-input" class="uk-margin-bottom" ><spring:message code="post.create.modal.tags.constrains"/></label>
                <div class="uk-flex">
                    <input id="add-tag-input" class="uk-input uk-margin-right uk-input uk-border-rounded uk-width-expand" placeholder="<spring:message code="post.create.modal.tagsPlaceholder"/>">
                    <button id="add-tag-button" class="uk-button uk-button-primary uk-border-rounded uk-width-auto" type="button"><spring:message code="post.create.modal.addButton"/></button>
                </div>
            </div>
