...
<body data-post-body="<c:out value="${post.body}"/>">
    ...
    <article class="uk-article">
        <div class="uk-container uk-container-small">
            ...
            <p class="uk-article-meta">Written on <c:out value="${post.creationDate}"/>. | <span data-uk-icon="icon: future"></span> Takes <c:out value="${post.readingTimeMinutes}"/> min reading.</p>
        </div>
        <div class="uk-container uk-container-small">
            <p id="unparsedBody">
